...
do
    ###########################################################################################################
    ./fwi.intel64 ../SetupParams/fwi_params.txt ../SetupParams/fwi_frequencies_small.txt  $i 2> fwi.$i.small.out
    ...
    #############################################################################################################
    ./fwi.intel64 ../SetupParams/fwi_params.txt ../SetupParams/fwi_frequencies_medium.txt $i 2> fwi.$i.medium.out
    ...
    ./fwi.intel64 ../SetupParams/fwi_params.txt ../SetupParams/fwi_frequencies_large.txt  $i 2> fwi.$i.large.out 
